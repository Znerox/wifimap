  ...
  while (($line = fgets($handle)) !== false) {
    ...
    if ($reached_client_list) {
      ...
      if  (substr($line, 2, 1) == ":" && substr($line, 93, 1) == ",") {
        ...
        $length_of_client_data_array_part_6 = strlen($client_data_array[6]);
        $length_of_uploaded_probed_essid_1 = $length_of_client_data_array_part_6 - 1;
        $uploaded_probed_essid_1_untrimmed = substr($client_data_array[6], 1, $length_of_uploaded_probed_essid_1);
