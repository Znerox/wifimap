    ...
    while (($line = fgets($handle)) !== false) {
        ...
        if ($reached_client_list) {
            ...
            if  (substr($line, 2, 1) == ":") {
                ...
                $length_of_uploaded_network_array_part_6 = strlen($uploaded_network_array[6]);
                $length_of_uploaded_probed_essid_1 = $length_of_uploaded_network_array_part_6 - 1;
                
                $uploaded_probed_essid_1_untrimmed = substr($uploaded_network_array[6], 1, $length_of_uploaded_probed_essid_1);
                ...
                if (!$client_query_result_array) {
                    ...
                    //this is to fix bug where client uploaded with one probe, '0'. probe would be added again on next run, because 0 is seen as empty probedb
