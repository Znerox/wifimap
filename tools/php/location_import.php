...
if ($handle) {
  while (($line = fgets($handle)) !== false) {
    ...
    $uploaded_bssid = $uploaded_location_data_array[1];
    $uploaded_level = $uploaded_location_data_array[2];
    $uploaded_lat = $uploaded_location_data_array[3];
    $uploaded_lon = $uploaded_location_data_array[4];
    $uploaded_altitude = $uploaded_location_data_array[5];
    $uploaded_accuracy = $uploaded_location_data_array[6];
    $uploaded_time = substr($uploaded_location_data_array[7], 0, 13);
